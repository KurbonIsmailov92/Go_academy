...
2. Реализовать соединение к БД через Golang приложение
3. Реализовать функцию получения списка всех сотрудников
4. Реализовать функцию получения сотрудника оп ID
*/
